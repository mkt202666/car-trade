...
--
--   后端登录逻辑：已有账号若未设置密码（password 为 NULL）时支持免密登录，
--   输入任意密码或空也可直接登录；若设置了 BCrypt 密码，则需正确密码。
...
VALUES (1, '13800138001', NULL, '诚信车行', '诚信二手车', 'A', 850, 156, 23, 'CERTIFIED', 'ACTIVE');

INSERT INTO users (id, phone, password, nickname, shop_name, credit_grade, credit_score, deal_count, on_sale_count, certification_status, status)
VALUES (2, '13800138002', NULL, '车坊张老板', '精品车坊', 'S', 920, 328, 45, 'CERTIFIED', 'ACTIVE');
