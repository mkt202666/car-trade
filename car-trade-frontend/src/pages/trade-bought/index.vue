<template>
  <view>
    <u-navbar title="买到的车" :border-bottom="false" :placeholder="true"></u-navbar>
    <view class="page-content">
      ...
      <u-empty v-if="orderList.length === 0 && !loading" mode="order" text="暂无买到的车"></u-empty>
...
export default {
  ...
  methods: {
    ...
    async loadOrders() {
      ...
      try {
        const res = await getOrderList({ page: this.page, pageSize: this.pageSize, role: 'BUYER' })
