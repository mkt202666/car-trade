...
export const getNotificationSettings = () => uni.$u.http.get('/messages/notification-settings')
export const updateNotificationSettings = (data) => uni.$u.http.put('/messages/notification-settings', data)
